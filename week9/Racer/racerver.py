...
icon = pygame.image.load("racer/images/vehicle.png") #
pygame.display.set_icon(icon)

background = pygame.image.load("racer/images/road.png")
...
class Enemy(pygame.sprite.Sprite):
    def __init__(self): 
        ...
        self.image = pygame.image.load(f'racer/images/Enemy'+f'/{self.rand}.png')
        self.rect = self.image.get_rect()
    ...
    def move(self):
        ...
        if (self.rect.bottom > 610): 
            ...
            self.image = pygame.image.load(f'racer/images/Enemy' + f'/{self.E}.png' )
            self.rect = self.image.get_rect()
            self.rect.center = (random.randint(20, 360), 10)   
...
class Coins(pygame.sprite.Sprite): 
    def __init__(self):
        ...
        self.image = pygame.image.load(f'racer/images/Coin/1.png') 
        self.rect = self.image.get_rect() 
...
class Bonuscoin(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.image = pygame.image.load(f'racer/images/Coin/maintenance.png')
        self.rect = self.image.get_rect()
...
class Beer(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load(f'racer/images/beer.png')
        self.rect = self.image.get_rect()
        self.rect.center = (random.randint(10, 390), 10)
        self.arus = 0
...
while running:
    ...
    dollarimage = pygame.image.load('racer/images/money.png')
    ...
    if pygame.sprite.spritecollideany(P1, enemies):
        pygame.mixer.Sound('racer/crash.mp3').play()
        photo = pygame.image.load("racer/images/gameover.jpg")   
    ...
    if pygame.sprite.spritecollideany(P1, coins):
        P1.BEER = True
        pygame.mixer.Sound('racer/coin.mp3').play()
        cnt+=1
        B1.ayou +=1
        Q1.arus +=1
        C1.rect.top = 600
    ...
    if pygame.sprite.spritecollideany(P1, beer):
        pygame.mixer.Sound('racer/beer-fridge.mp3').play()
    ...
    if show_bonus:
        ...
        image = pygame.image.load(f'racer/images/Coin/maintenance.png')
